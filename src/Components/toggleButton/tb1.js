...
export default class ToggleButton extends Component {
  ...
  get inputInfo() {
    ...
    info.attr.class = "btn toggle-button-custom";
...
Components.addComponent("toggleBtn", ToggleButton);
...
export default class ToggleButton extends Component {
  ...
  get inputInfo() {
    ...
    info.changeEvent = "click";
    info.attr.type = this.component.inputType || "button";
    info.attr.class = "btn toggle-button-custom toggle-button-custom-inactive";
    if (this.component.name) {
      info.attr.name = `data[${this.component.name}]`;
    }
    info.attr.value = this.component.value ? this.component.value : 0;
