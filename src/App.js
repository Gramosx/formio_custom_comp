...
const App = () => {
  const [form, setForm] = useState({
    ...
    components: [
      ...
      //       triggerType: "click",
      //       action: "javascript",
      //       code: "data.myButton = !data.myButton"
      //     }
      //   ]
      // }
    ]
  ...
  const handleFormChange = (updatedSchema) => {
    ...
    console.log("cloneComponents", cloneComponents);
    ...
    <div className="App">
      <div className="form-builder-wrapper">
        <FormBuilder
          ...
          onEditComponent={() => {
            // console.log("onEditComponent");
          }}
          onSaveComponent={() => {
            // console.log("onSaveComponent");
          }}
          onUpdateComponent={(event) => {
            // console.log("onUpdateComponent", event);
          }}
        />
      </div>
      ...
      <div className="form-preview-wrapper">
        <Card>
          ...
          <Card.Body>
            <Form key={JSON.stringify(form)} form={form} />
          </Card.Body>
        </Card>
      </div>
        ...
        <Card className="text-center">
          ...
          <Card.Body className="text-left">
            <AceEditor
              ...
              onChange={handleAceEditorChange} // Handle the change event
